...
<div class="w-full h-max flex flex-col mx-auto">
    ...
    <section
        ...
        <p class="w-11/12 max-w-[1134px] text-center text-base md:text-lg lg:text-2xl font-medium">Often those seeking custom lapel pins have a decision to make – pay much more for high-quality work or
            ...
            started now.</p>
        <div class="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-10 place-items-center place-content-between">
