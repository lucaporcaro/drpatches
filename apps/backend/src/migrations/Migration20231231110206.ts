...
export class Migration20231231110206 extends Migration {
  async up(): Promise<void> {
    this.addSql(
      'create table "patch_types" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "image" varchar(255) not null, "description" varchar(255) null, constraint "patch_types_pkey" primary key ("id"));',
    );
    this.addSql('create index "patch_types_id_index" on "patch_types" ("id");');
    this.addSql(
      'create index "patch_types_created_at_index" on "patch_types" ("created_at");',
    );
    this.addSql(
      'create index "patch_types_updated_at_index" on "patch_types" ("updated_at");',
    );
    ...
    this.addSql(
      'create table "products" ("id" varchar(255) not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null, "type" text check ("type" in (\'image\', \'text\')) not null, "text" varchar(255) null, "border_color" varchar(255) null default \'#fff\', "text_color" varchar(255) null default \'#111\', "background_color" varchar(255) null default \'#111\', "patch_width" int not null default 10, "patch_height" int not null default 10, "quantity" int not null default 50, "patch_type_id" varchar(255) null, "backing_type" text check ("backing_type" in (\'da_cucire\', \'termoadesiva\', \'velcro_a\', \'velcro_b\', \'velcro_a_b\')) not null default \'da_cucire\', "image" varchar(255) null, "price" double precision not null default 0, "status" text check ("status" in (\'created\', \'paid\', \'delivered\', \'cancelled\')) not null default \'created\', "user_id" varchar(255) not null, constraint "products_pkey" primary key ("id"));',
    );
    ...
    this.addSql(
      'create index "products_patch_type_id_index" on "products" ("patch_type_id");',
    );
    this.addSql(
    ...
    this.addSql(
      'alter table "products" add constraint "products_patch_type_id_foreign" foreign key ("patch_type_id") references "patch_types" ("id") on update cascade on delete set null;',
    );
    this.addSql(
  ...
  async down(): Promise<void> {
    this.addSql(
      'alter table "products" drop constraint "products_patch_type_id_foreign";',
    );
