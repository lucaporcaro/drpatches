    ...
    <div className='w-full h-max'>
      ...
      {open ? (
        <div
          ...
          onClick={toggle}>
          <div className='w-max h-max overflow-y-scroll max-w-[550px] py-10 px-4 bg-black rounded-lg grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-5 border-primary-1 border-2'>
            {items.map((item, i) => (
              <div
