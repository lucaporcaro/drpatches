...
export default async function ProfilePage({ children }: { children: any }) {
  return (
    <div className="w-full h-max flex-auto grid grid-cols-1 grid-rows-4 lg:grid-rows-1 lg:grid-cols-6 p-4 gap-2 place-items-start">
      <div className="w-full h-max p-4 lg:h-full lg:min-h-max lg:col-span-2 xl:col-span-1 bg-primary-1 border-[1px] rounded-xl flex flex-row gap-10 lg:flex-col lg:py-10">
