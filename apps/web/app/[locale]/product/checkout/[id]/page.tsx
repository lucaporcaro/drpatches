...
export default function CheckoutProductPage({ params: { id } }: Props) {
  ...
  return (
    ...
    >
      <div className="w-full h-full flex-auto bg-black border-primary-1 border-[1px] rounded-lg text-primary-1 flex flex-col items-center gap-10">
      ...
      <div className="w-full min-w-[420px] lg:w-max h-max bg-black border-[1px] border-primary-1 rounded-lg py-6 px-4 flex flex-col items-center justify-center gap-10">
